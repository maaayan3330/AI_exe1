...
def run_simulation():
    ...
    # שאלה 9
    actions = ['U', 'U', 'L', 'U', 'L', 'L', 'L', 'L', 'L', 'D', 'L', 'L', 'U', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'L', 'L', 'L', 'U', 'U', 'R', 'R', 'U', 'U', 'L', 'L', 'L', 'L', 'L', 'U', 'L', 'D', 'R',
                'R', 'R', 'R', 'R', 'R', 'R', 'U', 'U', 'U', 'L', 'U', 'L', 'U', 'R', 'U', 'R', 'D', 'D', 'D', 'D', 'D', 'D', 'L', 'D', 'R', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'R', 'R', 'D', 'L', 'U', 'L', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'R', 'D', 'L', 'L', 'L', 'L', 'L', 'L', 'D', 'L', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'R', 'U', 'U', 'L', 'L', 'D', 'R', 'D', 'R', 'U', 'L', 'U', 'R', 'R', 'D', 'L', 'D', 'L', 'L', 'L', 'L', 'L', 'L', 'R', 'D', 'D', 'R', 'D', 'L', 'L', 'L', 'L', 'L', 'L', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'R', 'R', 'R', 'R', 'R', 'L', 'D', 'R', 'L', 'D', 'D', 'L', 'D', 'D', 'D', 'L', 'U', 'R', 'R', 'D', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R']
    pygame.init()
