...
def run_simulation():
    ...
    # שאלה 9
    actions = ['U', 'R', 'D', 'R', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'R', 'U', 'L', 'R', 'R', 'U', 'U', 'L', 'L', 'D', 'L', 'D', 'D', 'R', 'D', 'L', 'U', 'U', 'U', 'U', 'U', 'L', 'U', 'R', 'R', 'R', 'U', 'R', 'R', 'R',
                'D', 'D', 'R', 'R', 'L', 'L', 'D', 'D', 'D', 'D', 'R', 'D', 'D', 'D', 'R', 'R', 'R', 'R', 'R', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'L', 'L', 'L', 'D', 'D', 'D', 'U', 'U', 'U', 'R', 'R', 'R', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'L', 'L', 'L', 'L']
    pygame.init()
